class Admin::UserProfilesController < Admin::BaseController
  ...
  def profile_params
    params.require(:profile).permit(:name, :birthday, :location, :school, :education, :company, :occupation, :position, :address, :qq, :github, :weibo, :wechat, :bio, :specialty, :introduce)
  end
end
